      ...
      schemas: {
        ...
        JourneySegment: {
          ...
          properties: {
            ...
            co2g:        { type: 'integer', description: 'Émissions CO2 en grammes (facteurs ADEME)', example: 261 },
        ...
        Journey: {
          ...
          properties: {
            ...
            label:            { type: 'string', example: 'Bus + Tramway', description: 'Modes utilisés joints par " + "' },
            ...
            co2SavingG:       { type: 'integer', description: 'Économie CO2 vs trajet voiture équivalent', example: 1158 },
            score:            { type: 'integer', minimum: 0, maximum: 100, description: 'Score multicritères (durée × CO2 × confort)', example: 74 },
          },
        },
      },
      securitySchemes: {
