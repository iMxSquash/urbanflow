...
export function EmptyResultsPanel({ time, options, onOptionsChange, onOpenSettings }: EmptyResultsPanelProps) {
    ...
    <div className="flex flex-col gap-3">
      <div className="flex items-start gap-3">
        <span className="size-11 rounded-md bg-warning-surface flex items-center justify-center shrink-0">
          <svg aria-hidden="true" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="text-warning">
      ...
      {suggestions.length > 0 && (
        <div className="flex flex-col gap-1.5">
          ...
          {suggestions.map((s) => (
            ...
            >
              <svg aria-hidden="true" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="text-primary shrink-0">
                {s.icon}
              </svg>
