...
export default function ParametresPage() {
  ...
  useGuestSafeEffect(fetchDemo, [fetchDemo])
    ...
    <PageWithSidebar>
      <div className="min-h-dvh bg-bg">
        ...
        <main className="max-w-2xl mx-auto px-4 pt-4 pb-28 flex flex-col gap-4 lg:max-w-260 lg:px-10 lg:py-8">
          <GuestLocked
            active={isGuest}
            title="Créez un compte pour accéder aux paramètres"
            description="Connectez-vous ou créez un compte gratuitement pour gérer votre compte et vos préférences."
          >
                ...
                >
                  <label className="flex items-center gap-2.5 cursor-pointer">
                    ...
                    <span className="flex-1 flex flex-col gap-0.5">
                      ...
                      <span
                        className={`text-caption ${demoMode ? 'text-warning' : 'text-text-muted'}`}
                      >
                  ...
                  <section className="card p-3.5" aria-labelledby="rights-heading">
                    ...
                    <ul className="flex flex-col gap-1.5 mt-2">
                      <li className="flex gap-2 text-caption text-text-muted">
                        ...
                        <span>
                          <b className="text-text">Droit d'accès</b> — vos données sont visibles
                          dans votre profil
                        </span>
                      </li>
                      <li className="flex gap-2 text-caption text-text-muted">
                        ...
                        <span>
                          <b className="text-text">Droit à l'effacement</b> — suppression du compte
                      ...
                      <li className="flex gap-2 text-caption text-text-muted">
                        ...
                        <span>
                          <b className="text-text">Données GPS</b> — jamais transmises à des tiers
                          ni stockées au-delà de la session
                        </span>
                      </li>
                    </ul>
                  </section>
